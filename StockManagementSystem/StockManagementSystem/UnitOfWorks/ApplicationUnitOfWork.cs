...
namespace StockManagementSystem.UnitOfWorks
{
    public class ApplicationUnitOfWork : UnitOfWork,IApplicationUnitOfwork
    {
        ...
        public ApplicationUnitOfWork(ApplicationDbContext dbContext,ICategoryRepository categories,ICompanyRepository companies,IItemRepository items) : base((DbContext)dbContext)
        {
            _items = items;
